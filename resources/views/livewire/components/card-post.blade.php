...
<div class="max-w-xl flex flex-col justify-stretch bg-gray-100 rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div class="flex justify-between px-4">
            <div class="flex items-center justify-center ">
                ...
                <span title="харесвания" class="flex-1">
                    @if ($post->likes > 0)
                        <span class="text-xs font-bold text-gray-700 dark:text-gray-100">
                            {{ $post->likes }}
                        </span>
                    @endif
                </span>
