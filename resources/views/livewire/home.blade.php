    ...
    @else
        <div class="flex flex-row items-center justify-center h-160">
            ...
            <div class="mt-6 text-center">
                <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Няма активни обяви</h1>
                <p class="mt-2 text-gray-500 dark:text-gray-300">Върнете се отново по-късно за актуални резултати.</p>
            </div>
        </div>
    @endif
</div>
